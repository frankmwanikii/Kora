<section class="how-to-order section" id="how-it-works" aria-labelledby="how-title">
    <div class="container">
        <div class="how-to-order__header reveal">
            <h2 id="how-title" class="section-label">How to Order</h2>
            <p class="lead-italic">A straightforward process, with enough care at every step to make the final object feel right.</p>
        </div>
        <ol class="order-steps reveal">
            ...
            <li class="order-step">
                ...
                <div class="order-step__icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M10 17h4M3 6h18v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Zm2-4h14l-1.5-3H5Z"/></svg>
                </div>
